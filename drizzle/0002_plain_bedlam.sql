...
ALTER TABLE "enrollments" ADD CONSTRAINT "enrollments_course_courses_id_fk" FOREIGN KEY ("course") REFERENCES "public"."courses"("id") ON DELETE no action ON UPDATE no action;